package Questions.Collection.OMG1;
import java.io.*;
...
public class Read {
    ...
    public static void getFile() {
        ...
        try {
            File csvFile = new File("C:\\Users\\Administrator\\IdeaProjects\\LearningProcess\\untitled\\src\\main\\java\\Interview_Questions\\Collection\\Read\\template.csv");
...
//                    quick compare time large or not to store into the map.
